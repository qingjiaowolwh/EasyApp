...
/**
 * Created by lwh on 2016/10/18.
 */

public class EasyPhotoView extends ImageView{
    ...
    float oldDist = 1f;
    float oldRotation = 0;
    public EasyPhotoView(Context context) {
        super(context);
        setupView();
    }

    public EasyPhotoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupView();
    }
    ...
    public void setupView(){
        ...
        this.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                EasyPhotoView.this.setImageMatrix(matrix);
//                CheckView();
                return true;
            }
        });
