...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, SurfaceHolder.Callback, JCMediaManager.JCMediaPlayerListener {
    ...
    protected void init(Context context) {
        ...
        ivStart = (ImageView) this.findViewById(R.id.start);
        ivFullScreen = (ImageView) this.findViewById(R.id.fullscreen);
        skProgress = (SeekBar)this. findViewById(R.id.progress);
        tvTimeCurrent = (TextView)this. findViewById(R.id.current);
        tvTimeTotal = (TextView)this. findViewById(R.id.total);
        llBottomControl = (ViewGroup) this.findViewById(R.id.layout_bottom);
        rlSurfaceContainer = (RelativeLayout)this. findViewById(R.id.surface_container);
        llTopContainer = (ViewGroup)this. findViewById(R.id.layout_top);
